...
<head>
    ...
    <link href="{{ asset('foto/car.png') }}" rel="icon">
    <style>
        .w3-sidebar a {
...
<body class="w3-content" style="max-width:1200px">
    ...
    <nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
        <div class="w3-container w3-display-container w3-padding-16">
            ...
            <h3 class="w3-wide"><a href="{{ url('/') }}"><img style="width:80%" src="{{ asset('foto/logo.png') }}"></a></h3>
        </div>
    ...
    <div class="w3-main" style="margin-left:250px">
        ...
        <header class="w3-container w3-xlarge">
            ...
            <p class="navbar">
                ...
                <b>{{ auth()->user()->name }}</b>
                &nbsp;
                <a href="{{ url('logout') }}"><img src="{{ asset('foto/exit.png') }}" rel="logout" style="width:4%;"></a>
                @else
                <a href="{{ url('login') }}"><img src="{{ asset('foto/enter.png') }}" rel="login" style="width:4%;"></a>
                <a href="{{ url('registration') }}"><img src="{{ asset('foto/add-user.png') }}" rel="register" style="width:4%;"></a>
                @endif
            </p>
