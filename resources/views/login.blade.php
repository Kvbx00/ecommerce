...
<body class="w3-content" style="max-width:1200px">
  ...
  <div class="w3-main">
    ...
    <div class="login-main">
        <div><h3><b>Logowanie</b></h3></div>
            <input class="l-input" type="text" placeholder="Email" name="" required>
            <input class="l-input" type="password" placeholder="Hasło" name="psw" required>
            <button class="submit-login">Zaloguj</button>
    </div>
